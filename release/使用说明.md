...
**版本：v1.0.0** ｜ [下载最新版](https://github.com/Alooshy0827/StatsOSD/releases/latest) ｜ Windows 10/11 x64 ｜ [许可：专有软件](LICENSE)
...
1. 解压 `StatsOSD-v1.0.0-win-x64.zip`，双击 `StatsOSD.exe`
...
> 已是管理员时，托盘菜单显示灰色的「已以管理员运行」；否则点「以管理员重启」。
